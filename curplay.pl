...
if($player eq "org.mpris.amarok"){ system("amarok &");}
  ...
  sub playversion {
    ...
    my $RAND2 = int(rand($RANGE));
    my $RAND3 = int(rand($RANGE));
    IRC::command("/me \003".$RAND1."is using \003".$RAND2."the homegrown \003".$RAND3."Clarjon1 and Kevin147's \003".$RAND1."Annoying \003".$RAND2."Song\003".$RAND3." Announcer on-chat-display (ASAocd) \003".$RAND2."VERSION\003".$RAND1." ".$version."!! Hosted on Github ( https://github.com/clarjon1/Annoying-Song-Announcer )  ");
    }
